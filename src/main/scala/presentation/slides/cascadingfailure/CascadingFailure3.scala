...
case class CascadingFailure3[F[_] : Sync : NConsole]() extends SimpleSlide[F] {
  ...
  val content =
    Sync[F].pure("""
      ...
      | | |                                           | |                         | |                                           | |                         | |                                           | |
      | | |                                           | |                         | |                                           | |                         | |                                           | |
      | |_|           ___     _ _ _                   |_|                    __   |_|           ___     _ _ _                   |_|                    __   |_|           ___     _ _ _                   |_|
      | | |          |__|_ _(_) (_)_ _  __ _          | |  ___ ___ ___ ___ __\ \  | |          |__|_ _(_) (_)_ _  __ _          | |  ___ ___ ___ ___ __\ \  | |          | __|_ _(_) (_)_ _  __ _         | |
      | | |          | _/ _` | | | | ' \/ _` |        | | |___|___|___|___|___> > | |          | _/ _` | | | | ' \/ _` |        | | |___|___|___|___|___> > | |          | _/ _` | | | | ' \/ _` |        | |
      | | |          |_|\__,_|_|_|_|_||_\__, |        | |                    /_/  | |          |_|\__,_|_|_|_|_||_\__, |        | |             | |    /_/  | |          |_|\__,_|_|_|_|_||_\__, |        | |
      ...
      | | |          |__|_ _(_) (_)_ _  __ _          | |  ___ ___ ___ ___ __\ \  | |          |__|_ _(_) (_)_ _  __ _          | |  ___ ___ ___| |
      | | |          | _/ _` | | | | ' \/ _` |        | | |___|___|___|___|___> > | |          | _/ _` | | | | ' \/ _` |        | | |___|___|___|_|
      | | |          |_|\__,_|_|_|_|_||_\__, |        | |                    /_/  | |          |_|\__,_|_|_|_|_||_\__, |        | |
      | |_|                             |___/         |_|                         |_|                             |___/         |_|
      | | |                                           | |                         | |                                           | |
      | | |                                           | |                         | |                                           | |
